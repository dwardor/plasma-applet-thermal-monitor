...
function getTemperatureStr(celsiaDouble, temperatureUnit) {
    ...
    // use nedit to get proper utf-8 string for � which is °
    return getTemperature(celsiaDouble, temperatureUnit) + (temperatureUnit === TemperatureUnit.CELSIUS ? '°C' : temperatureUnit === TemperatureUnit.FAHRENHEIT ? '°F' : 'K')
}
